define(['jquery', 'collections/speakers', 'collections/days', 'collections/talks', 'models/day', 'models/speaker', 'models/talk', 'models/conference' ], function($, Speakers, Days, Talks, Day, Speaker, Talk, Conference){
